...
In [this repository](https://github.com/PlatformedTasks/PLAS-charts) you can find all the Helm charts used by the [PLAS project](https://github.com/PlatformedTasks/Documentation).
